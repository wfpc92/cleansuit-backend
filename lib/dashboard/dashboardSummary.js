...
var now = moment();
var firstDay = moment.utc([now.year(), now.month(), 1, 0, 0, 0]).toDate();
...
function dashboardSummary(Restangular) {
    ...
    return {
        ...
        controller: ['$scope', function($scope) {
            ...
            Restangular
                .all('usuarios')
                .getList({limit: 100, _sortField: 'createdAt', _sortDir: 'DESC', _filters: {'createdAt__gte':firstDay.toISOString(), 'rol':'cliente'}})
                .then(customers => {
