function basket() {
  ...
  return {
    ...
    controller: ['$scope', function($scope) {
      ...
      // TODO edit only if ($scope.editable) {
...
<tr ng-if="['nueva', 'rutaRecoleccion', 'cancelada'].indexOf(orden.estado) != -1" ng-repeat="item in orden.items">
    ...
    <td class="ng-admin-type-amount">{{ item.precio * item.cantidad | number: 0 | numeraljs:'$0,0.' }}</td>
</tr>
...
<tr class="active">
    ...
    <td class="ng-admin-type-amount">{{ orden['orden.totales.subtotal'] | number: 0 | numeraljs:'$0,0.' }}</td>
</tr>
<tr>
    <td colspan="3"></td>
    <td>Domicilio</td>
...
<tr>
    <td colspan="3"></td>
    <td>Impuestos</td>
    <td class="ng-admin-type-number">{{ orden['orden.totales.impuestos'] | number: 0 | numeraljs:'$0,0.' }}</td>
</tr>
<tr>
    <td colspan="3"></td>
    <td class="text-success">Abono</td>
    <td class="ng-admin-type-number text-success">{{ orden['orden.abono'] | number: 0 | numeraljs:'$0,0.' }}</td>
</tr>
<tr>
    <td colspan="3"></td>
    <td><strong>Total</strong></td>
    <td class="ng-admin-type-amount"><strong>{{ orden['orden.totales.total'] | number: 0 | numeraljs:'$0,0.' }}</strong></td>
</tr>
</tbody>
</table>
`
