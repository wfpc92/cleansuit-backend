        ...
        switch (status) {
          ...
          case 'rutaRecoleccion':
            if (scope.form && scope.form.$dirty) {
              return notification.log('Guarde los cambios antes de Confirmar.', {
                addnCls: 'humane-flatty-error'
              })
            }
          ...
          case 'rutaEntrega':
            if (scope.form && scope.form.$dirty) {
              return notification.log('Guarde los cambios antes de Facturar. Si ya los guardó y no puede Facturar, por favor refresque la página.', {
                addnCls: 'humane-flatty-error'
              })
            } else if (!scope.orden.values.domiciliario_entrega_id) {
            ...
            modalInstance = $uibModal.open({
              ...
              template: `
                <div class="modal-header">
                  <h3 class="modal-title" id="modal-title">Finalizar Proceso</h3>
                </div>
              ...
              resolve: {
                msg: function() {
                  return 'Fueron todas las prendas de esta orden procesadas y están completas?'
                }
              },
            });
